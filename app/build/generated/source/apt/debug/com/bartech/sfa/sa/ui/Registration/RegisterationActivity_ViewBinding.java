...
public class RegisterationActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public RegisterationActivity_ViewBinding(RegistrationActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public RegisterationActivity_ViewBinding(final RegistrationActivity target, View source) {
    this.target = target;
